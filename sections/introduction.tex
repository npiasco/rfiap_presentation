...
\begin{frame}{Various modalities}
	...
	\begin{minipage}{0.4\linewidth}
		\centering
		\only<1>{\includegraphics[width=\linewidth]{intro_fig/modalities/rgb}}
		\only<2>{\includegraphics[width=\linewidth]{intro_fig/modalities/depth}}
		\only<3>{\includegraphics[width=\linewidth]{intro_fig/modalities/ref}}
		\only<4>{\includegraphics[width=\linewidth]{intro_fig/modalities/semantic}}
	\end{minipage}
\end{frame}
